...
1. Скачайте `ScreenOff-1.1.0-arm64.dmg` из [Releases](../../releases/latest). При обновлении сначала завершите старый ScreenOff кнопкой питания в меню.
